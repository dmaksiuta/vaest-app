				...
				>
					<SwiperSlide>
						<div className="gallery__picture picture">
							<Image width={894} height={502} src="/main-bg-1.jpg" alt="restaurant building" />
					...
					<SwiperSlide>
						<div className="gallery__picture picture">
							<Image width={894} height={502} src="/main-bg-2.jpg" alt="restaurant building" />
						</div>
					</SwiperSlide>
					<SwiperSlide>
						<div className="gallery__picture picture">
							<Image width={894} height={502} src="/main-bg-3.jpg" alt="restaurant building" />
						</div>
					</SwiperSlide>
				</Swiper>
			</div>
