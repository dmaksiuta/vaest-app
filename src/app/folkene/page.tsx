    ...
    return (
        <div className="folkene-section">
            ...
            <div className="folkene-section__row row">
                <Image width={679} height={540} src="/folkene/Folkene-1.webp" alt="Kasper Kau photo"/>
            ...
            <div className="folkene-section__row row">
                <Image width={679} height={540} src="/folkene/Folkene-2.webp" alt="Trine Kau photo"/>
                <div className="row__info">
            ...
            <div className="folkene-section__row row">
                <Image width={679} height={540} src="/folkene/Folkene-3.png" alt="Mogens Kjær photo"/>
                <div className="row__info">
            ...
            <div className="folkene-section__row row">
                <Image width={679} height={540} src="/folkene/henrik_1327.jpeg" alt="Henrik Pedersen photo"/>
                <div className="row__info">
            ...
            <div className="folkene-section__row row">
                <Image width={679} height={540} src="/folkene/Folkene-5.webp" alt="Ole Hosbond Poulsen photo"/>
                <div className="row__info">
            ...
            <div className="folkene-section__row row">
                <Image width={679} height={540} src="/folkene/Folkene-6.png" alt="Asger Larsen photo"/>
                <div className="row__info">
